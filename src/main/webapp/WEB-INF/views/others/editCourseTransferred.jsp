...
<c:set var="headElements">
  <title>CESAR - Edit Course Transferred</title>
	...
	/* <![CDATA[ */
	          $(function() {
	             ...
	             $( "#deleteButton" ).click( function(){
	 		    	var url = 'deleteCourseTransferred.html?id=${courseTransferred.id}';
...
<c:set var="user" value="${courseTransferred.student}" />
<br />
...
&gt; <a href="<c:url value='/user/display.html?userId=' />${user.id} ">${user.name}</a>  &gt; Edit Course Transferred </h3>
<p><a href="<c:url value='/user/display.html?userId=' />${user.id}&#tab-courses">View</a> | Edit</p>

<form:form modelAttribute="courseTransferred">
  <form:hidden path="id" />
